...
export const SEED_PRODUCTS: Product[] = [
  // ── ADHESION PREVENTION ──────────────────────────────
  {
    ...
    variants: [
      ...
      v('MateRegen Gel 5ml', '5ml版', 16190, {
        selfPayCode: 'FSZ001142001',
        patientPrice: 17000,
      }),
  ...
  // ── HEMOSTASIS ───────────────────────────────────────
  {
    ...
    variants: [
      v('SM0005-USA', '1公克', 7175, {
        ...
        patientPrice: 10500,
        hospitalPrices: { tucheng:6933, tzuchi:8048, sph:6933, eck:7429, tmuh:7000 },
        hospitalInfo: { eck: { hospitalCode:'97U1153', patientPrice:10500, purchasePrice:7800 } },
      }),
      v('SM0002-USA', '3公克', 12499, {
        selfPayCode: 'TTZ030696002',
        patientPrice: 21000,
        hospitalPrices: { tucheng:12171, tzuchi:14000, eck:15238, grace:15381, tmuh:14762 },
        hospitalInfo: { eck: { hospitalCode:'97U1150', patientPrice:21000, purchasePrice:16000 } },
      }),
      ...
      v('TTZ030696004', '14cm 塗佈器 ×2', 1857, {
        ...
        patientPrice: 3000,
        hospitalInfo: { eck: { hospitalCode:'97U1151', patientPrice:3000, purchasePrice:1950 } },
      }),
      v('AM0005', '38cm 加長型塗佈器', 2033, {
        selfPayCode: 'TTZ030696005',
        patientPrice: 3000,
        hospitalPrices: { grace:2286, eck:1486, tmuh:1524, clinic:1448 },
        hospitalInfo: { eck: { hospitalCode:'97U1152', patientPrice:3000, purchasePrice:1950 } },
      }),
    ],
    createdAt: new Date().toISOString(),
  },
  ...
  // ── HERNIA ───────────────────────────────────────────
  {
    ...
    variants: [
      v('0113115', '15釘', 6296, {
        ...
        hospitalInfo: { eck: { hospitalCode:'9710320', patientPrice:11034, purchasePrice:8500 } },
        unit: '組',
      }),
    ],
    createdAt: new Date().toISOString(),
  },
  {
    ...
    variants: [
      ...
      v('Hermesh 8 15×15', '15×15 cm', 1103, {
        ...
        patientPrice: 1603,
        hospitalPrices: { tzuchi:1095, sph:1059, tmuh:1143 },
        hospitalInfo: { eck: { hospitalCode: undefined, patientPrice:1603, purchasePrice:1202 } },
        unit: '片',
      }),
    ],
    createdAt: new Date().toISOString(),
  },
  {
    ...
    variants: [
      v('0115310', '3D MAX 中/左', 6952, {
        selfPayCode: 'FSZ009255001',
        patientPrice: 10000,
        hospitalPrices: { eck: Math.round(7300/1.05) },
      ...
      v('0117311', '3DMAX LIGHT 大/左',   6190, { selfPayCode:'FSZ009255001', unit:'片' }),
      v('0117312', '3DMAX LIGHT 特大/左', 6168, { selfPayCode:'FSZ009255001', unit:'片' }),
      v('0117321', '3DMAX LIGHT 大/右',   6189, { selfPayCode:'FSZ009255001', unit:'片' }),
      v('0117322', '3DMAX LIGHT 特大/右', 6168, { selfPayCode:'FSZ009255001', unit:'片' }),
    ],
    createdAt: new Date().toISOString(),
  },
  ...
  // ── URINARY INCONTINENCE ─────────────────────────────
  {
    ...
    variants: [
      v('IS-M1', '迷你懸吊手術系統', 21861, {
        selfPayCode: 'FSZ031551001',
        patientPrice: 35000,
        hospitalInfo: { eck: { hospitalCode:'97U0627', patientPrice:35000, purchasePrice:25000 } },
        unit: '組',
      }),
      v('IS-TOMS-1', 'Toms 懸吊系統', 71429, {
        nhiCode: 'FSP72STMS142',
        patientPrice: 100000,
        hospitalInfo: { eck: { hospitalCode:'97U0628', patientPrice:100000, purchasePrice:75000 } },
        unit: '組',
      }),
      v('IS-1', '懸吊帶系統（健保）', 9453, {
        nhiCode: 'FSP71ST10042',
        patientPrice: 13482,
        hospitalInfo: { eck: { hospitalCode:'97Y6002', patientPrice:13482, purchasePrice:9926 } },
        unit: '組',
      }),
      v('IS-6', '懸吊帶系統 IS-6', 9734, {
        nhiCode: 'FSP71ST10042',
        patientPrice: 13482,
        unit: '組',
      }),
      v('IS-HELICO-01', '懸吊帶系統 HELICO', 9023, {
        nhiCode: 'FSP71ST10042',
        patientPrice: 13482,
        hospitalInfo: { eck: { hospitalCode:'97Y6002', patientPrice:13482, purchasePrice:9926 } },
        unit: '組',
