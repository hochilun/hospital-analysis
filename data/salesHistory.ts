...
export const SALES_BY_YEAR: Record<string, YearSalesData> = {
  ...
  '2026': {
    ...
    MONTHLY_REV: [
      ...
      { month: '9月', rev: 552_385 },  // 9/1–9/23（資料截止 9/23；共跑認領由前端動態加上）
    ],
    MONTHLY_BY_HOSPITAL: [
      ...
      { month: '9月', 中心診所: 49_524,   台北醫學: 151_429,  宏恩醫療: 2_560,   恩主公: 65_543,  沙爾德聖: 283_330 },
    ],
    MONTHLY_BY_CATEGORY: [
      ...
      { month: '9月', Hemostasis: 56_039,  'Adhesion Prevention': 297_714, Hernia: 100_631, 'Urinary Incontinence': 98_000 },
    ],
  },
};
