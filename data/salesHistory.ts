...
export const SALES_BY_YEAR: Record<string, YearSalesData> = {
  ...
  '2026': {
    ...
    MONTHLY_REV: [
      ...
      { month: '8月', rev: 725_155 },  // 8/1–8/20（partial；含共跑認領由前端動態加上）
    ],
    MONTHLY_BY_HOSPITAL: [
      ...
      { month: '8月', 中心診所: 49_543,   台北醫學: 181_143,  宏恩醫療: 48_762,  恩主公: 146_448, 沙爾德聖: 299_260 },
    ],
    MONTHLY_BY_CATEGORY: [
      ...
      { month: '8月', Hemostasis: 142_552, 'Adhesion Prevention': 387_620, Hernia: 153_078, 'Urinary Incontinence': 41_905 },
    ],
  },
};
