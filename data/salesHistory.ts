...
export const SALES_BY_YEAR: Record<string, YearSalesData> = {
  ...
  '2026': {
    ...
    MONTHLY_BY_HOSPITAL: [
      ...
      { month: '6月', 中心診所: 25_905,   台北醫學: 60_000,   宏恩醫療: 10_240,  恩主公: 105_486, 沙爾德聖: 270_680, 台北慈濟: 12_973 },
    ],
    MONTHLY_BY_CATEGORY: [
      ...
      { month: '6月', Hemostasis: 28_019,  'Adhesion Prevention': 358_286, Hernia: 98_979,  'Urinary Incontinence': 0 },
    ],
  },
};
