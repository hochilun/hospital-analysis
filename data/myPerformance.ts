...
export const MY_PERFORMANCE: MonthPerf[] = [
  ...
  },
  {
    ...
    byCategory: {
      'Adhesion Prevention':  505_001,
      'Hernia':               167_079,
      'Hemostasis':           165_560,
      'Urinary Incontinence': 44_000,
    },
    byProduct: [
      { name: '宮安康',      category: 'Adhesion Prevention',  qty: 40, rev: 453_201 },
      { name: '3DMAX LIGHT', category: 'Hernia',               qty: 18, rev: 117_000 },
      { name: '止血顆粒 3g', category: 'Hemostasis',           qty:  7, rev: 106_600 },
      { name: '塞納斯',      category: 'Adhesion Prevention',  qty:  4, rev:  51_800 },
      { name: 'IS-M1',       category: 'Urinary Incontinence', qty:  2, rev:  44_000 },
      { name: '止血顆粒 5g', category: 'Hemostasis',           qty:  1, rev:  24_500 },
      { name: '止血顆粒 1g', category: 'Hemostasis',           qty:  3, rev:  22_360 },
      { name: '凡萃拉',      category: 'Hernia',               qty:  1, rev:  20_130 },
      { name: '速巴定',      category: 'Hernia',               qty:  2, rev:  16_224 },
      { name: '賀邁補',      category: 'Hernia',               qty: 13, rev:  13_725 },
      { name: '止血塗佈器',  category: 'Hemostasis',           qty:  6, rev:  12_100 },
    ],
    hospitalProducts: {
      '沙爾德聖': [
        { name: '宮安康',      category: 'Adhesion Prevention',  qty: 28, rev: 308_001 },
        { name: 'IS-M1',       category: 'Urinary Incontinence', qty:  2, rev:  44_000 },
        { name: '止血顆粒 3g', category: 'Hemostasis',           qty:  3, rev:  42_600 },
        { name: '止血顆粒 1g', category: 'Hemostasis',           qty:  2, rev:  14_560 },
        { name: '賀邁補',      category: 'Hernia',               qty: 12, rev:  12_525 },
        { name: '速巴定',      category: 'Hernia',               qty:  1, rev:   7_724 },
      ],
      '台北醫學': [
        { name: '3DMAX LIGHT', category: 'Hernia',              qty: 18, rev: 117_000 },
      ...
      '宏恩醫療': [
        { name: '塞納斯',     category: 'Adhesion Prevention', qty:  1, rev:  12_800 },
        { name: '止血塗佈器', category: 'Hemostasis',          qty:  1, rev:   2_400 },
      ],
    },
  },
  {
    ...
    byCategory: {
      'Adhesion Prevention':  312_600,
      'Hernia':               108_035,
      'Urinary Incontinence': 102_900,
      'Hemostasis':            62_461,
    },
    byProduct: [
      { name: '宮安康',      category: 'Adhesion Prevention',  qty: 23, rev: 260_600 },
      { name: '3DMAX LIGHT', category: 'Hernia',               qty: 14, rev:  91_200 },
      { name: 'P-STOP-8',    category: 'Urinary Incontinence', qty:  2, rev:  76_400 },
      { name: '塞納斯',      category: 'Adhesion Prevention',  qty:  4, rev:  52_000 },
      { name: '止血顆粒 1g', category: 'Hemostasis',           qty:  4, rev:  30_161 },
      { name: '止血顆粒 3g', category: 'Hemostasis',           qty:  2, rev:  28_400 },
      { name: 'IS-M1',       category: 'Urinary Incontinence', qty:  1, rev:  26_500 },
      { name: '速巴定',      category: 'Hernia',               qty:  1, rev:   8_500 },
      { name: '賀邁補',      category: 'Hernia',               qty: 10, rev:   8_335 },
      { name: '止血塗佈器',  category: 'Hemostasis',           qty:  2, rev:   3_900 },
    ],
    hospitalProducts: {
      '沙爾德聖': [
        { name: '宮安康',      category: 'Adhesion Prevention',  qty: 16, rev: 176_000 },
        { name: 'P-STOP-8',    category: 'Urinary Incontinence', qty:  2, rev:  76_400 },
        { name: '止血顆粒 3g', category: 'Hemostasis',           qty:  2, rev:  28_400 },
        { name: '止血顆粒 1g', category: 'Hemostasis',           qty:  2, rev:  14_561 },
        { name: '賀邁補',      category: 'Hernia',               qty:  5, rev:   4_975 },
      ],
      '台北醫學': [
      ...
      '恩主公': [
        { name: '宮安康',      category: 'Adhesion Prevention', qty: 3, rev: 36_600 },
        { name: '止血顆粒 1g', category: 'Hemostasis',          qty: 2, rev: 15_600 },
        { name: '速巴定',      category: 'Hernia',              qty: 1, rev:  8_500 },
        { name: '3DMAX LIGHT', category: 'Hernia',              qty: 1, rev:  6_700 },
        { name: '止血塗佈器',  category: 'Hemostasis',          qty: 2, rev:  3_900 },
      ],
      '中心診所': [
        { name: '塞納斯', category: 'Adhesion Prevention', qty: 4, rev: 52_000 },
...
export const SHARED_PERFORMANCE: Record<string, Record<string, HospProdEntry[]>> = {
  ...
  '2026-08': {  // 8/1–8/31
    ...
    '長庚土城': [ // 整院 應收 1,198,540 / 加權 1,090,076
      { name: '止血顆粒 3g', category: 'Hemostasis', qty: 38, rev: 539600, weighted: 462514 },
      { name: '宮安康', category: 'Adhesion Prevention', qty: 43, rev: 473000, weighted: 450476 },
      { name: 'IS-M1', category: 'Urinary Incontinence', qty: 3, rev: 66000, weighted: 62857 },
      { name: '止血顆粒 1g', category: 'Hemostasis', qty: 8, rev: 58240, weighted: 55467 },
      { name: 'P-STOP-8', category: 'Urinary Incontinence', qty: 1, rev: 38200, weighted: 36381 },
      { name: '止血顆粒 5g', category: 'Hemostasis', qty: 1, rev: 23500, weighted: 22381 },
    ],
  },
  '2026-09': {  // 9/1–9/23
    '台北慈濟': [ // 整院 應收 721,866 / 加權 687,491
      { name: '宮安康', category: 'Adhesion Prevention', qty: 20, rev: 260000, weighted: 247619 },
      { name: '宮安康 10ML', category: 'Adhesion Prevention', qty: 8, rev: 180000, weighted: 171429 },
      { name: '止血顆粒 3g', category: 'Hemostasis', qty: 11, rev: 161700, weighted: 154000 },
      { name: '塞納斯', category: 'Adhesion Prevention', qty: 3, rev: 36000, weighted: 34286 },
      { name: '止血顆粒 1g', category: 'Hemostasis', qty: 3, rev: 25350, weighted: 24143 },
    ...
    '長庚土城': [ // 整院 應收 722,808 / 加權 655,694
      { name: '止血顆粒 3g', category: 'Hemostasis', qty: 22, rev: 312400, weighted: 267771 },
...
export const SHARED_AUTO: Record<string, Record<string, HospProdEntry[]>> = {
  ...
  '2026-07': {
    '台北慈濟': [ // 本人業績 應收 115,852 / 加權 110,335
      { name: '止血顆粒 5g', category: 'Hemostasis', qty: 3, rev: 73500, weighted: 70000 },
